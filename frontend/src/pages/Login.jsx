...
import { Mail, Smartphone, ShieldCheck, Lock } from 'lucide-react';
...
const Login = ({ onLogin }) => {
  ...
  const handleGoogleLogin = () => {
    ...
    if (onLogin) onLogin(userSession);
    alert('🌐 Google Authentication successful! Logging in...');
    navigate(`/${role}`);
  };
        ...
        {authMethod === 'google' && (
          <div style={{ textAlign: 'center' }}>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem', marginBottom: '1.5rem' }}>
              Connect with your Google Account to access hyperlocal delivery networks instantly.
            </p>
